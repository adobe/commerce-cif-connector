...
/**
 * Collects all cloud commerce providers and builds the list of available catalog identifiers
 * (project in UI) for each of them.
 */
...
public class CatalogIdentifierServiceImpl implements CatalogIdentifierService {
  ...
  @Reference(service = CatalogIdentifier.class, bind = "bindCatalogIdentifier",
      unbind = "unbindCatalogIdentifier", cardinality = ReferenceCardinality.AT_LEAST_ONE,
