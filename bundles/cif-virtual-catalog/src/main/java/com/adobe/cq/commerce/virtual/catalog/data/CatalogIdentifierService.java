...
/**
 * Service for getting all catalog identifiers (projects in UI) for all cloud commerce provider
 * implementations.
 */
public interface CatalogIdentifierService {
   ...
   *
   * @return A map where the keys are the names of the commerce providers and the values are a
   *         collection of all catalog identifiers for that specific commerce provider.
   */
