...
public class IsProductListPageServletTest {
    private IsProductListPageServlet servlet;
    private SlingHttpServletRequest request;
    private SlingHttpServletResponse response;
    private ValueMap resourceProperties;

    @Rule
    public final AemContext context = createContext("/context/is-product-list-page-servlet-test-context.json");
    ...
    @Test
    public void testNoProductListPage() throws Exception {
        resourceProperties.put("path", "/content/noproductlistpage");
