...
public class GraphqlQueryLanguageProviderTest {
  ...
  public void setUp() throws Exception {
    ...
    Mockito.when(graphqlDataService.searchProducts(Mockito.any(), Mockito.any(), Mockito.any()))
  ...
  public void testQueryLanguageProvider() throws IOException {
    ...
    Mockito.verify(graphqlDataService, Mockito.times(1)).searchProducts("gloves",
