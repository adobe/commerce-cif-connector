...
public class SyntheticImageResource extends ImageResource {
  ...
  /**
   * Creates an <code>ImageResource</code> based on a <code>SyntheticResource</code>. This class
   * returns the path of the SyntheticResource when {@link ImageResource#getFileReference()} is
   * called.
   *
   ...
   */
  public SyntheticImageResource(ResourceResolver resolver, String path, String slingResourceType,
      String url) {
