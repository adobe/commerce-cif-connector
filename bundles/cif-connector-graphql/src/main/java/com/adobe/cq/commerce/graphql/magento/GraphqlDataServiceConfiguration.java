...
public @interface GraphqlDataServiceConfiguration {
  ...
  @AttributeDefinition(name = "Magento GraphQL Service Identifier",
      description = "A unique identifier for this configuration, used in the JCR resource property "
          + CQ_CATALOG_IDENTIFIER
  ...
  @AttributeDefinition(name = "Magento root category id",
      description = "The ID of the root category.", type = AttributeType.INTEGER, required = true)
  int rootCategoryId();

  @AttributeDefinition(name = "Magento store view",
      description = "The code of the Magento store view.", type = AttributeType.STRING)
  String storeCode() default STORE_CODE_DEFAULT;

  @AttributeDefinition(name = "Enable/disable product data caching",
  ...
  @AttributeDefinition(name = "Product caching time in minutes",
  ...
  @AttributeDefinition(name = "Product cache size (= number of products in the cache).",
  ...
  @AttributeDefinition(name = "Category cache size (= number of categories in the cache)",
  ...
  @AttributeDefinition(name = "Enable/disable catalog caching",
  ...
  @AttributeDefinition(name = "Catalog caching time in minutes",
  ...
  @AttributeDefinition(name = "Enable/disable cache scheduler",
