...
public interface GraphqlDataService {
   ...
   * @exception RuntimeException if the GraphQL HTTP request does not return 200 or if the JSON
   *            response cannot be parsed or deserialized.
   */
   ...
   * @param pageSize Specifies the maximum number of results to return at once. This attribute is
   *        optional.
