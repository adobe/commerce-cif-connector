...
/**
 * Resource implementation for the root category node of the product tree. This node has a special
 * status because it's backed by a JCR node and still served by the resource provider of the virtual
 * product tree.
 */
