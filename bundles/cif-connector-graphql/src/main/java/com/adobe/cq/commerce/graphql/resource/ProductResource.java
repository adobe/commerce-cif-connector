...
class ProductResource extends SyntheticResource {
  ...
  /**
   * Creates a SyntheticResource for the given Magento GraphQL product. The
   * <code>activeVariantSku</code> parameter must be set if the product is a leaf variant not having
   * any child nodes.
   * 
   * @param resourceResolver The resource resolver.
   * @param path The path of the resource.
  ...
  public <AdapterType> AdapterType adaptTo(Class<AdapterType> type) {
    if (type == ValueMap.class) {
      ...
      return (AdapterType) new MagentoProduct(getResourceResolver(), getPath(), magentoProduct,
          activeVariantSku);
    }
